 ...
 * - QuestionTreeRenderer — takes a QuestionTree (from backend/question-tree/builder.ts)
 *   and renders it as DOM inside the overlay panel
 * - uses a single event delegation root on the overlay container (no per-button listeners)
...
export {}; // placeholder so TS doesn't complain about an empty module
